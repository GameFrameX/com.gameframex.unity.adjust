...
namespace GameFrameX.AdJust.Runtime
{
    ...
    public interface IAdJustManager
    {
        /// <summary>
        /// 初始化 AdJust SDK
        /// </summary>
        ...
        [UnityEngine.Scripting.Preserve]
        void Init(bool debug, string appToken, AdjustLogLevel logLevel, AdjustEnvironment environment);
        ...
        [UnityEngine.Scripting.Preserve]
        void Event(string eventName, Dictionary<string, string> eventValues, string productId = null, string transactionId = null, double revenue = 0, string currency = "USD");
        ...
        [UnityEngine.Scripting.Preserve]
        void EventAd(string eventName, double revenue, string currency, string adRevenueNetwork = null, string adRevenuePlacement = null, string adRevenueUnit = null);
    }
}